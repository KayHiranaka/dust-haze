############
# Remove pixels with SNR under 20
#############
...
#    ax.plot(wave, error_frat, '0.5')
    ...
    plt.title('%s, L%s, S/N cutoff = 10'%(red,stype))
...
#    ax2.plot(wave, error_frat, '0.5')
    ...
    plt.title('%s, L%s, S/N cutoff = 10'%(des,st))
